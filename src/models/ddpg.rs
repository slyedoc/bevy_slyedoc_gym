// use crate::{ environments::{ActionType, ObservationType}};
...
// const REPLAY_BUFFER_CAPACITY: i64 = 100_000;
// // The training batch size for each training iteration.
// const TRAINING_BATCH_SIZE: i64 = 100;
// // The total number of episodes.
// const MAX_EPISODES: i64 = 100;
// // The maximum length of an episode.
// const EPISODE_LENGTH: i64 = 200;
// // The number of training iterations after one episode finishes.
// const TRAINING_ITERATIONS: i64 = 200;
...
// pub struct DdpgModelPlugin;

// impl Plugin for DdpgModelPlugin {
//     fn build(&self, app: &mut AppBuilder) {
//         app.add_system(step.system())
//     }
// }
...
//             //     let mut action = 2.0 * f64::from(self.agent.actions(&obs));
//             //     action = action.max(-2.0).min(2.0);
//             //     let step = env.step(ActionType::Continuous(action));
//             //     total_reward +=  step.reward;


//             //     self.agent.remember(&obs, &action.into(), &step.reward.into(), step.obs.into());
//             //     if step.is_done {
//             //         break;
//             //     }
//             //     obs = step.obs;
...
//             //     self.agent.train(TRAINING_BATCH_SIZE);
//             // }
//         }
...
// impl OuNoise {
//     fn new(mu: f64, theta: f64, sigma: f64, num_actions: i64) -> Self {
//         let state = Tensor::ones(&[num_actions], FLOAT_CPU);
//         Self {
//             mu,
//             theta,
//             sigma,
...
// impl ReplayBuffer {
//     fn new(capacity: i64, num_obs: i64, num_actions: i64) -> Self {
//         Self {
//             obs: Tensor::zeros(&[capacity, num_obs], FLOAT_CPU),
//             next_obs: Tensor::zeros(&[capacity, num_obs], FLOAT_CPU),
//             rewards: Tensor::zeros(&[capacity, 1], FLOAT_CPU),
//             actions: Tensor::zeros(&[capacity, num_actions], FLOAT_CPU),
//             capacity,
//             len: 0,
//             i: 0,
//         }
...
//     fn random_batch(&self, batch_size: i64) -> Option<(Tensor, Tensor, Tensor, Tensor)> {
//         if self.len < 3 {
//             return None;
//         }

//         let batch_size = batch_size.min(self.len - 1);
//         let batch_indexes = Tensor::randint(self.len - 2, &[batch_size], INT64_CPU);
...
// impl Actor {
//     fn new(num_obs: i64, num_actions: i64, learning_rate: f64) -> Self {
...
//         Self {
//             network: nn::seq()
//                 .add(nn::linear(p / "al1", num_obs, 400, Default::default()))
//                 .add_fn(|xs| xs.relu())
...
//     fn train(&mut self, batch_size: i64) {
